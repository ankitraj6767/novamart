...
## Phase 3 — Seller Platform  ✅ complete
...
## Phase 4 — Customer Shopping  ✅ complete
...
## Phase 6 — Checkout & Inventory  ✅ complete
...
## Phase 14 — Recommendations  ✅ complete
...
Nova AI shopping assistant now has a grounded catalog-only API boundary in `/nova`; provider
backends can be added later without allowing unverified prices, stock or product claims.
